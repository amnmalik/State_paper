...
database_data <- getQuery(prj, query = 'CO2 emissions by sector', scenario = "NZ_Final") %>%
...
output_path <- "C:/Users/Anurag/Downloads/AllSectorEmissions_NZ_2020model.xlsx"
write.xlsx(database_grouped, output_path)
...
output_path <- "C:/Users/Anurag/Downloads/AllSectorEmissions_NZ.xlsx"
