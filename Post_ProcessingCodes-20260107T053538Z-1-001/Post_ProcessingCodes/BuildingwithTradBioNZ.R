...
real_data <- read_excel("C:/Users/Anurag/Downloads/StateIntegrationGraphs/BuildingResidential.xlsx")

# Load the master sheet data
master_sheet <- read_excel("C:/Users/Anurag/Downloads/trajectory_BuildingEnergyNZ.xlsx")
...
output_file <- "C:/Users/Anurag/Downloads/Final_Energy_Building_NZ.xlsx"
